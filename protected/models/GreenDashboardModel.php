 ...
 */
class GreenDashboardModel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GreenDashboardModel the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_green, isi, tipe, id_menu, id_menu_admin', 'safe', 'on'=>'search'),
		);
	}
