 ...
 */
class ProfilDashboardModel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProfilDashboardModel the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('judul, keterangan, url_route, widget_st', 'required'),
			array('widget_st', 'numerical', 'integerOnly'=>true),
			array('judul', 'length', 'max'=>150),
			array('url_route', 'length', 'max'=>50),
