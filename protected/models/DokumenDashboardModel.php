 ...
 * @property string $rangkuman
 * @property string $jenis
 */
class DokumenDashboardModel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return DokumenDashboardModel the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id_kat_dokumen, nama_dokumen, gambar, keterangan, nama_file, rangkuman', 'required'),
			array('id_kat_dokumen', 'numerical', 'integerOnly'=>true),
			array('nama_dokumen', 'length', 'max'=>150),
			array('gambar, nama_file', 'length', 'max'=>50),
			array('jenis', 'length', 'max'=>30),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_dokumen, id_kat_dokumen, nama_dokumen, gambar, keterangan, nama_file, rangkuman, jenis', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array('KategoriDokumen'=>array(self::BELONGS_TO,'KatDokumenModel','id_kat_dokumen'));
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_kat_dokumen' => 'Kategori Dokumen',
	...
	public function search()
	{
		...
		$criteria->compare('rangkuman',$this->rangkuman,true);
