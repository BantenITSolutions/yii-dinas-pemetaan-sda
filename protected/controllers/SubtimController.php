...
class SubtimController extends Controller
{
	...
	public function actionDetail()
	{
        ...
        $criteria->condition = 'id_subtim = '.Yii::app()->getRequest()->getQuery('id').'';
        $dt = SubtimModel::model()->findAll($criteria);
	...
	public function actionKonten()
	{
		...
		$dataProvider=new CActiveDataProvider('SubtimModel', array(
			'pagination'=>array(
