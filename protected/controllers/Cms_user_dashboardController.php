...
class Cms_user_dashboardController extends Controller
{
	...
	{
		$model=new DashboardUserModel('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DashboardUserModel']))
			$model->attributes=$_GET['DashboardUserModel'];
	 ...
	 * @return DashboardUserModel the loaded model
