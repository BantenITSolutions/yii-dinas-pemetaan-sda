...
class DbiController extends Controller
{
	...
	public function actionExcel_public()
	{
		$model=new InfrastrukturModel();
	...
	public function actionClear_filter()
	{
		...
		?><script type="text/javascript">window.top.location.href='<?php echo Yii::app()->baseUrl; ?>/dbi';</script><?php
	}

	public function actionReset_columns()
	{
		$names = InfrastrukturModel::model()->getAttributes(); 
	...
	public function actionColumns()
	{
		...
		if(isset($_POST['InfrastrukturModel']))
		{
			$model->attributes=$_POST['InfrastrukturModel'];
	...
	public function actionIndex()
	{
        ...
        $dt = InfrastrukturModel::model()->findAll($criteria);

		$model=new InfrastrukturModel('search');
		$model->unsetAttributes();
		if(isset($_GET['InfrastrukturModel']))
			$model->attributes=$_GET['InfrastrukturModel'];
