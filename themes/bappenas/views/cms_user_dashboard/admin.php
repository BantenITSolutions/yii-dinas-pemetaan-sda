...
$('.search-form form').submit(function(){
	$('#dashboard-user-model-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="widget first">
        <div class="head"><h5 class="iCreate">Welcome, <?php echo Yii::app()->user->nama_lengkap; ?></h5></div>
            <div class="body">
				...
				<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_user_dashboard/create',array('class'=>'btn14')); ?>
				...
				$this->beginWidget('CActiveForm', array(
			        ...
			        'action' => array('cms_user_dashboard/deleteall'),
			        'enableAjaxValidation' => true,
			    ));
			    $this->widget('zii.widgets.grid.CGridView', array(
					'id'=>'dashboard-user-model-grid',
