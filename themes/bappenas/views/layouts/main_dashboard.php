...
<script type="text/javascript"> 
    ...
    $(document).ready(function(){
        $(".boxOver").colorbox({rel:'group', iframe:true, width:"700", height:"90%"});
        $(".unitKerjaAgenda").colorbox({
            rel:'group', 
            iframe:true, 
            width:"700", 
            height:"90%",
                onClosed:function(){
                $('#unit_kerja').load('<?php echo Yii::app()->baseUrl.'/cms_agenda/unit_kerja'; ?>');
            }
        });
        
        $(".tempatAgenda").colorbox({
            rel:'group', 
            iframe:true, 
            width:"700", 
            height:"90%",
                onClosed:function(){
                $('#tempat_agenda').load('<?php echo Yii::app()->baseUrl.'/cms_agenda/tempat_agenda'; ?>');
            }
        });
    });
...
<div id="topNav">
    <div class="fixed">
        <div class="wrapper">
            <div class="welcome"><span>Welcome, <?php echo Yii::app()->user->nama_lengkap; ?></span></div>
            <div class="userNav">
                <ul>
                    <li><a href="<?php echo Yii::app()->baseUrl; ?>/cms" title=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/admin/images/icons/topnav/settings.png" alt="" /><span>CMS Front</span></a></li>
...
<div id="header" class="wrapper">
    <div class="logo"><a href="/" title=""><h1>CMS - TIM KERJA KONEKTIVITAS - KP3EI</h1></a><p></p><h3>Locally Integrated - Globally Connected</h3></div>
    </div>
    <div class="fix"></div>
</div>
