...
<div style="width:100%; margin:0px auto; padding:0px;">
	<div style="width:100%; margin:0px auto; padding:0px; float:right; background-color:#fff;">
	
	<iframe id="iframe" src="<?php echo Yii::app()->baseUrl; ?>/proyek_prioritas/data"  width="100%" height="550px" marginheight="0" frameborder="0"  onLoad="autoResize('iframe')";></iframe>

	<div style="overflow:scroll; width:98%; padding-left:2%; padding-bottom:10px;">
<h2><?php echo CHtml::link('PROYEK PRIORITAS',array("/site")); ?></h2>
<script type="text/javascript">
function cek(param)
{
	$.ajax({
	    type: 'post',
	    url: '<?php echo Yii::app()->baseUrl; ?>/proyek_prioritas/set/',
...
function cek_field(param)
{
	$.ajax({
	    type: 'post',
	    url: '<?php echo Yii::app()->baseUrl; ?>/proyek_prioritas/set_field/',
	    data: 'set_param='+param,
		    success: function(response) {
		    }
		});
...
$(document).ready(function() {
  	$.ajax({
	    type: 'post',
	    url: '<?php echo Yii::app()->baseUrl; ?>/proyek_prioritas/set_resolusi/',
...
if(Yii::app()->user->isGuest)
{
	...
	echo CHtml::link("Download Excel Data", Yii::app()->baseUrl.'/proyek_prioritas/excel_public', array("class" => "boxHover2"));
...
{
	echo '<div class="cleaner_h10"></div>';
	echo CHtml::link("Select columns to show", Yii::app()->baseUrl.'/proyek_prioritas/columns', array("class" => "boxHover"));
	echo CHtml::link("Reset to Defaults", Yii::app()->baseUrl.'/proyek_prioritas/reset_columns', array("class" => "boxHover2"));
	echo CHtml::link("Download Excel Data", Yii::app()->baseUrl.'/proyek_prioritas/excel_private', array("class" => "boxHover2"));
	echo '<div class="cleaner_h30"></div>';
