...
<h3>Manage Pelaksana</h3>

<?php echo CHtml::link('Advanced Search','#',array('class'=>'search-button btn btn-small btn-inverse')); ?> 
<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_pelaksana/create',array('class'=>' btn btn-small btn-inverse')); ?>
<div class="span2"></div>
...
<?php 
	$this->beginWidget('CActiveForm', array(
        ...
        'action' => array('cms_pelaksana/deleteall'),
