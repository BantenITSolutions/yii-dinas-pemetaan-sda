    ...
    <div class="widget first">
        <div class="head"><h5 class="iCreate">Welcome, <?php echo Yii::app()->user->nama_lengkap; ?></h5></div>
            <div class="body">
				...
				<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_proyek_prioritas/create',array('class'=>'btn14')); ?>
				...
				$this->beginWidget('CActiveForm', array(
			        ...
			        'action' => array('cms_proyek_prioritas/deleteall'),
					...
					'columns'=>array(
			            array(
					     ...
					     array(
					      ...
					      'value'=>'$data->Infrastruktur->nama_proyek'
					      ),
						array(
							'class'=>'CButtonColumn',
						),
