...
$('.search-form form').submit(function(){
	$('#banner-dashboard-model-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="widget first">
        <div class="head"><h5 class="iCreate">Welcome, <?php echo Yii::app()->user->nama_lengkap; ?></h5></div>
            <div class="body">
				...
				<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_banner/create',array('class'=>'btn14')); ?>
				...
				$this->beginWidget('CActiveForm', array(
			        'id' => 'banner-dashboard-model-form',
			        'action' => array('cms_banner/deleteall'),
			        'enableAjaxValidation' => true,
			    ));
				$this->widget('zii.widgets.grid.CGridView', array(
					'id'=>'banner-dashboard-model-grid',
