...
$this->menu=array(
	...
	array('label'=>'Update KoridorModel', 'url'=>array('update', 'id'=>$model->id_kawasan)),
	array('label'=>'Delete KoridorModel', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id_kawasan),'confirm'=>'Are you sure you want to delete this item?')),
