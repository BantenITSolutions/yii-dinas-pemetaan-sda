...
<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_kawasan/create',array('class'=>' btn btn-small btn-inverse')); ?>
<div class="span2"></div>
...
<?php
	$this->beginWidget('CActiveForm', array(
        ...
        'action' => array('cms_kawasan/deleteall'),
