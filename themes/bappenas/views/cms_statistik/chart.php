...
<?php foreach($dt_header as $dt_g): ?>
	...
	<li>
		<div class="title"><h3><a href="<?php echo Yii::app()->baseUrl; ?>/cms_statistik/detail/<?php echo $dt_g['id_header_statistik']; ?>">Statistik Dwelling Time <?php echo $dt_g['jalur']; ?></a></h3></div>
