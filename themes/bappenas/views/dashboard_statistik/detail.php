...
<?php foreach($dt_header as $dt_g): ?>
	...
	<li>
		<div class="title"><h3><a href="<?php echo Yii::app()->baseUrl; ?>/dashboard_statistik/export/<?php echo $dt_g['id_header_statistik']; ?>">Export Datagrid to Excell</a></h3></div>
		<?php
    	...
    	?>
		<div class="title"><h3><a href="<?php echo Yii::app()->baseUrl; ?>/dashboard_statistik/chart"><< Kembali</a></h3></div>
