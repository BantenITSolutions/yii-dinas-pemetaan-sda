...
$('.search-form form').submit(function(){
	$('#link-dashboard-model-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="widget first">
        <div class="head"><h5 class="iCreate">Welcome, <?php echo Yii::app()->user->nama_lengkap; ?></h5></div>
            <div class="body">
				...
				<?php echo CHtml::link('Add Data',Yii::app()->baseUrl.'/cms_link/create',array('class'=>'btn14')); ?>
